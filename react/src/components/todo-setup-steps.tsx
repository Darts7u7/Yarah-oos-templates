...
export function TodoSetupSteps({ tableExists, hasData, playground, onRefresh, isRefreshing }: TodoSetupStepsProps) {
...
export function DebugPromptBlock({ onRefresh, isRefreshing }: { onRefresh: () => void; isRefreshing: boolean }) {
  return (
