...
A two-sided booking marketplace built with Next.js, Tailwind CSS, and Yarah — customers discover providers, request appointments at open time slots, exchange messages, and leave reviews after the session is complete.
...
![Yarah Booking starter preview](../assets/covers/booking.png)
...
6. Apply the included schema and seed data to your Yarah project. You can either ask your agent using this prompt:
   ...
   ```bash
   npx @yarahdev/cli db query -- "$(cat migrations/db_init.sql)"
   ```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FYarah%2Fyarah-templates%2Ftree%2Fmain%2Fbooking&root-directory=booking&project-name=yarah-booking&repository-name=yarah-booking&env=NEXT_PUBLIC_YARAH_URL,NEXT_PUBLIC_YARAH_ANON_KEY&envDescription=Connect%20your%20Yarah%20project%20URL%20and%20anon%20key.)
...
- Add Stripe via the Yarah payments module if you want to capture a deposit at booking time instead of letting providers run their own payment process.
